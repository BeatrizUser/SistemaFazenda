"""
Django settings for SistemaFazenda project.
...
SECRET_KEY = 'django-insecure-_(@7rgbhk91cv#8f#yzg89a(54r%&9z9^qu2fe_lo@za1d8*=^'
...
ROOT_URLCONF = 'SistemaFazenda.urls'
...
WSGI_APPLICATION = 'SistemaFazenda.wsgi.application'
